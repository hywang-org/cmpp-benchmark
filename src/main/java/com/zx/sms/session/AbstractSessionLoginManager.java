...
import static com.zx.sms.common.GlobalConstance.CONN_SUCCESS_PROMISE;
...
public abstract class AbstractSessionLoginManager extends ChannelDuplexHandler {
    ...
    private void receiveConnectResponseMessage(ChannelHandlerContext ctx, Object message) {
        ChannelPromise promise = ctx.channel().attr(CONN_SUCCESS_PROMISE).get();
